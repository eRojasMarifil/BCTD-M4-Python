class Vehiculo:
    #constructor con parametros para realizar una instancia de Ia clase Vehiculo
    ...
    #constructor sin parametros de entrada para instanciar un objeto Vehículo
...
#creando una instancia de Ia clase Vehiculo
